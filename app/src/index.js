...
const App = {
  ...
  processItem: function (event) {
    ...
    processItem(this.upc).send({from: this.account})
    .then(function(result) {
        $("#ftc-item").text(result);
  ...
  packItem: function (event) {
    ...
    packItem(this.upc).send({from: this.account})
    .then(function(result) {
        $("#ftc-item").text(result);
  ...
  sellItem: function (event) {
    ...
    sellItem(this.upc, this.productPrice).send({from: this.account})
    .then(function(result) {
        $("#ftc-item").text(result);
  ...
  buyItem: function (event) {
    ...
    buyItem(this.upc).send({from: this.account})
    .then(function(result) {
        $("#ftc-item").text(result);
  ...
  shipItem: function (event) {
    ...
    shipItem(this.upc).send({from: this.account})
    .then(function(result) {
        $("#ftc-item").text(result);
  ...
  receiveItem: function (event) {
    ...
    receiveItem(this.upc).send({from: this.account})
    .then(function(result) {
        $("#ftc-item").text(result);
  ...
  purchaseItem: function (event) {
    ...
    purchaseItem(this.upc).send({from: this.account})
    .then(function(result) {
        $("#ftc-item").text(result);
  ...
  fetchItemBufferOne: function () {
    ...
    fetchItemBufferOne(this.upc).call()
    .then(function(result) {
      $("#ftc-item").text(result);
  ...
  fetchItemBufferTwo: function () {
    ...
    fetchItemBufferTwo(this.upc).call().then(function(result) {
      $("#ftc-item").text(result);
